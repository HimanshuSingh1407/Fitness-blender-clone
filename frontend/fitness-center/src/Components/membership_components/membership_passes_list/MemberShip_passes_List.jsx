...
import MemberShipPassesfour from "../../homepage/HomePageAssets/membership_passes-720_4.webp"
const MemberShip_passes_List = () => {
  return (
    <Box
  ...
  >
    ...
    >
      <Center>
        <Image src={MemberShipPassesfour} alt="team" />
      </Center>
    </Center>
  </Box>
  )
...
export default MemberShip_passes_List